...
def parameter_parser():
    ...
    # Input-Output
    parser.add_argument(
        "--input_nodes", default="./input/nodes_191120.csv", type=str, help="input_file"
    )
    parser.add_argument(
        "--input_edges", default="./input/edges_191120.csv", type=str, help="input_file"
    )
    parser.add_argument(
        "--input_path", default="./input/paths/", type=str, help="input_path"
    )
    parser.add_argument(
        "--output_path", default="./output/", type=str, help="output_path"
    )
    ...
    parser.add_argument(
        "--window_size", default=3, type=int, help="context window size"
    )
    ...
    parser.add_argument(
        "--initial_lr", default=0.0025, type=float, help="learning rate"
    )
    ...
    parser.add_argument(
        "--number_of_walks", default=100, type=int, help="number of walks"
    )
    # 'walk' how long?
    ...
    parser.add_argument(
        "--len_metapath", default=50, type=int, help="length of metapath"
    )
    ...
    # Pytorch
    parser.add_argument(
        "--seed", type=int, default=42, help="Random seed for PyTorch. Default is 42."
    )
